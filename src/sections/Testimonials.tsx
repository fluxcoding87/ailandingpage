  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        <h2 className="text-5xl md:text-6xl text-center tracking-tighter font font-medium ">
          Beyond Expectations.
        </h2>
            ...
            {[...testimonials, ...testimonials].map((testimonial) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mt-5">
                  <div className="relative after:content-[''] after:absolute after:inset-0 after:bg-[rgb(140,69,255)] after:mix-blend-soft-light before:absolute before:inset-0 before:content-[''] before:border before:border-white/30 before:z-10 before:rounded-lg">
                    <Image
