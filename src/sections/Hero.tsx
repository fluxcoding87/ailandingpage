  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute size-5 left-full border border-white inline-flex items-center justify-center rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <div className="container relative mt-16">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          ...
          technology meets user-firendly SEO tools.
        </p>
